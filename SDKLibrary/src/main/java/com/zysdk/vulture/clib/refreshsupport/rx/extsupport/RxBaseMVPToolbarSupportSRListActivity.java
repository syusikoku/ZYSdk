package com.zysdk.vulture.clib.refreshsupport.rx.extsupport;
...
import com.zysdk.vulture.clib.refreshsupport.rx.smartrefresh.RxBaseMVPSRRListActivity;
...
public abstract class RxBaseMVPToolbarSupportSRListActivity<P extends BasePresenter<V>, V extends
        ISampleRefreshView, T> extends RxBaseMVPSRRListActivity<P, V, T> {
