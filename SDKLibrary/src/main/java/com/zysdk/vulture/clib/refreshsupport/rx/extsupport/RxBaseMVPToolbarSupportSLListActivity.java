...
import com.zysdk.vulture.clib.refreshsupport.rx.smartrefresh.RxBaseMVPSRLListActivity;
...
public abstract class RxBaseMVPToolbarSupportSLListActivity<P extends BasePresenter<V>, V extends
        ISampleRefreshView, T> extends RxBaseMVPSRLListActivity<P, V, T> {
