package com.zysdk.vulture.clib.refreshsupport.rx.smartrefresh;
...
import com.zysdk.vulture.clib.mvp.rx.RxBaseMVPSupportActivivty;
 ...
 */
public abstract class RxBaseAbsSmartRefreshListActivity<P extends BasePresenter<V>, V extends
        IView, T> extends RxBaseMVPSupportActivivty<P, V> implements LMRecyclerView
        .OnFooterAutoLoadMoreListener, IListDataView<T> {
