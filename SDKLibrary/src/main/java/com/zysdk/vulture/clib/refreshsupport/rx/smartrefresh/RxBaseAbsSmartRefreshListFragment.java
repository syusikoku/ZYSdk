 ...
 */
public abstract class RxBaseAbsSmartRefreshListFragment<P extends BasePresenter<V>, V extends
        IView, T> extends RxBaseMVPSupportFragment<P, V> implements LMRecyclerView
