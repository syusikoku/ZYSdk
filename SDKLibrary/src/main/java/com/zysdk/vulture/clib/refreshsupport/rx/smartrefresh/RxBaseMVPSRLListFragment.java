...
public abstract class RxBaseMVPSRLListFragment<P extends BasePresenter<V>, V extends
        ISampleRefreshView, T> extends RxBaseMVPSupportFragment<P, V> implements LMRecyclerView
