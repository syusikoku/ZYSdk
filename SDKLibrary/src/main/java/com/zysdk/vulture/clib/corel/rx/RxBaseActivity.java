package com.zysdk.vulture.clib.corel.rx;
...
public abstract class RxBaseActivity extends RxAppCompatActivity implements IActivityLifeCycle, View
    ...
    protected void showPermissionDenyDialog(String tips) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RxBaseActivity.this);
