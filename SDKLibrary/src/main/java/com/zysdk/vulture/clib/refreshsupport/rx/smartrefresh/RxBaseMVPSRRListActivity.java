...
public abstract class RxBaseMVPSRRListActivity<P extends BasePresenter<V>, V extends
        ISampleRefreshView, T> extends RxBaseMVPSupportActivivty<P, V> implements LMRecyclerView
