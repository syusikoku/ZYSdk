...
public abstract class BaseAbsHaoRefreshMvpListActivity<P extends BasePresenter<V>, V extends IView,
        T> extends BaseMVPSupportActivivty<P, V> implements IView {
