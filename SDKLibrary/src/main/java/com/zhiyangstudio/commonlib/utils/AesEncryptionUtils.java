...
public class AesEncryptionUtils {
    ...
    // 随机源的种子
    public static String AES_KEY = "default_key";
    ...
    public static String encrypt(SecretKeySpec key, String content) {
        ...
        try {
            ...
            // 为了避免解密时数据丢失，将加载后的内容进行Base64编码后再返回
    ...
    public static SecretKeySpec createKey() {
        try {
            ...
            // 初始化密钥生成器,指定密钥的长度(单位:bit),SecureRandom是生成安全随机数序列
            SecureRandom secureRandom = new SecureRandom(AES_KEY.getBytes());
